...
public class SteganographyController
{
	 ...
	 */
	public SteganographyController(SteganographyView aView, Steganography aModel)
	{
		//program variables
		view  = aView;
		model = aModel;
	...
	private class Exit implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			new SteganographyView("Steganography").setVisible(false);
	...
	{
		new SteganographyController(
									new SteganographyView("Steganography"),
									new Steganography()
									);
	}
}